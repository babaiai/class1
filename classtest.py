...
with st.expander("K線圖, 移動平均線"):
    ...
    fig1.add_trace(go.Bar(x=KBar_df['data'], y=KBar_df['transaction'], name='成交量', marker=dict(color='black')),secondary_y=False)  ## secondary_y=False 表示此圖形的y軸scale是在左邊而不是在右邊
